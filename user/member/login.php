    ...
    <div class="container-fluid mt-5 d-flex justify-content-evenly">
        <main class="form-signin w-50">
            <form action="" method="POST">
                <h1 class="h3 mb-3 fw-normal">Login Membership</h1>
                <?php if (isset($error)) :?>
                ...
                <button class="w-100 mb-3 btn btn-lg btn-danger" name="loginMember" id="submit" type="submit">Login</button>
                <a class="d-flex mb-3" href="password/srcEmail.php">Lupa Password?</a>
                <div class="container mt-3 mb-5 p-0">
                <p>Belum punya akun? <a class="mt-5 mb-5" href="../../membership/register.php">buat akun</a></p>
                </div>
            </form>
        </main>
        <div class="img">
