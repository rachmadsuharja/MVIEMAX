...
<head>
    ...
    <title>Role | Halaman Admin</title>
...
<body class="bg-dark">
    <nav class="navbar navbar-expand-lg bg-danger">
        <div class="container-fluid">
            <div class="container d-flex align-items-center">
                <h1 class="navbar-brand text-white">Role</h1>
            </div>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                <a class="nav-link text-white" aria-current="page" href="role.php">Role</a>
                </li>
    ...
    <?php
        ...
        $role = mysqli_query($con, "SELECT * FROM membership_role");
        session_start();
    ...
    ?>
        <div class="tbHead w-100 d-flex justify-content-around align-items-center">
            ...
            <a class="btn btn-primary p-1 m-2" href="roleSettings/add.php"><i class="fa-solid fa-circle-plus"></i> Tambah Role</a>
        </div>
...
<script>
    ...
    table = document.getElementById("roleList");
