...
<body class="bg-dark">
    <nav class="navbar navbar-expand-lg bg-danger">
        <div class="container-fluid">
            <div class="container d-flex align-items-center">
                <h1 class="navbar-brand text-white">Publisher</h1>
            </div>
    ...
    <?php
        ...
        $publisher = mysqli_query($con, "SELECT * FROM film_publisher");
        session_start();
...
<script>
    ...
    table = document.getElementById("filmPublisher");
