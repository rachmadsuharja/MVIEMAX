...
<body class="bg-dark">
        ...
        if (isset($_GET['id'])) {
            ...
            <script>
                ...
                if (result.isConfirmed) {
                    window.location.href = "feedbackSettings/delete.php?id=<?= $_GET['id'] ?>";
                }
                })
            </script>
            <?php
    ...
    ?>
        ...
        <table id="feedbackList" class="table table-dark" style="color: #dddd;">
            ...
            <tr>
                <th>
                    <a class="btn btn-outline-primary p-1" href="feedbackSettings/update.php?id=<?= $row['id'] ?>"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
