    ...
    <div class="container w-100 h-100 p-3 d-flex justify-content-center align-items-center">
        ...
        <form action="" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" name="email" id="email" placeholder="name@name.com" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <button type="submit" name="submit" id="submit" class="btn btn-danger">Kirim</button>
            </div>
        </form>
    </div>
</body>
