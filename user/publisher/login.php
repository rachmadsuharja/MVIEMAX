    ...
    <div class="container-fluid mt-5 d-flex justify-content-evenly">
        <main class="form-signin w-50">
            <form action="" method="POST">
                <h1 class="h3 mb-3 fw-normal">Login Publisher</h1>
                <?php if (isset($error)) :?>
                ...
                <button class="w-100 mb-3 btn btn-lg btn-danger" name="loginPublisher" id="submit" type="submit">Login</button>
                <a class="d-flex mb-3" href="password/srcUser.php">Lupa Password?</a>
                <div class="container mt-3 mb-5 p-0">
                <p>Belum punya akun? <a class="mt-5 mb-5" href="../../publisher/register.php">buat akun</a></p>
                </div>
            </form>
        </main>
        <div class="img">
            <img class="mb-4" src="../../assets/img/logo.png" alt="" width="300" height="300">
        </div>
    </div>
</div>
</body>
